...
class TestListCommand:
  ...
  def test_initialize__attributes(
    ...
    assert list_command_instance.command_name == as_translation("list")
  ...
  def test_initialize__translations(
    ...
    assert_is_translated(list_command_instance.command_name)
  ...
  def test_invoke__lists_and_prints_documentation(
    ...
    list_command_instance.invoke(mocked_args)
