...
class TestResultForest:
  ...
  def test_lookup__valid_source__valid_lookup__uses_cloned_cursor(
      self,
      result_forest_instance: ResultForest,
  ...
  def test_lookup__valid_source__creates_lookup_sequence(
      self,
      result_forest_instance: ResultForest,
      mocked_controller: mock.Mock,
      mocked_existing_tree: mock.Mock,
  ...
  def test_lookup__valid_source__valid_operations__calls_all_lookup_operations(
      self,
      result_forest_instance: ResultForest,
      mocked_controller: mock.Mock,
      mocked_existing_tree: mock.Mock,
  ...
  def test_lookup__valid_static_value__returns_correct_results(
      self,
      result_forest_instance: ResultForest,
      mocked_controller: mock.Mock,
  ) -> None:
