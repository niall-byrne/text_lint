...
class TestLogger:
  ...
  def test_initialize__attributes(
    ...
    assert logger_instance.controller == mocked_controller
  ...
  def test_call__assertion__current_index__correct_stdout(
    ...
    mocked_controller.textfile.index = text_file_start_index
  ...
  def test_call__assertion__ranged_index__correct_stdout(
    ...
    mocked_controller.textfile.index = text_file_start_index + 5
