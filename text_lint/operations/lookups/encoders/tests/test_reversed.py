...
class TestReversedEncoder:
  ...
  def test_initialize__inheritance(
      self,
      concrete_reversed_encoder_instance: ReversedEncoder,
  ) -> None:
    assert isinstance(
        concrete_reversed_encoder_instance,
        ReversedEncoder,
    )
    assert isinstance(
        concrete_reversed_encoder_instance,
  ...
  def test_encode__non_list_tuple_or_dict_value__pass_through(
    ...
    return_value = concrete_reversed_encoder_instance.encode(mocked_object)
  ...
  def test_apply__vary_value__returns_expected_value(
    ...
    return_value = concrete_reversed_encoder_instance.encode(result)
