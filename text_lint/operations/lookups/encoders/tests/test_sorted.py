...
class TestSortedEncoder:
  ...
  def test_initialize__inheritance(
      self,
      sorted_encoder_instance: SortedEncoder,
  ) -> None:
    assert isinstance(
        sorted_encoder_instance,
        SortedEncoder,
    )
    assert isinstance(
        sorted_encoder_instance,
  ...
  def test_encode__non_list_tuple_or_dict_value__pass_through(
    ...
    return_value = sorted_encoder_instance.encode(mocked_object)
  ...
  def test_apply__vary_value__returns_expected_value(
    ...
    return_value = sorted_encoder_instance.encode(result)
