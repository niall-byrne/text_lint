...
class TestUpperCaseEncoder:
  ...
  def test_initialize__inheritance(
      self,
      concrete_upper_case_encoder_instance: UpperCaseEncoder,
  ) -> None:
    assert isinstance(
        concrete_upper_case_encoder_instance,
        UpperCaseEncoder,
    )
    assert isinstance(
        concrete_upper_case_encoder_instance,
  ...
  def test_encode__non_string_value__pass_through(
    ...
    return_value = concrete_upper_case_encoder_instance.encode(mocked_object)
