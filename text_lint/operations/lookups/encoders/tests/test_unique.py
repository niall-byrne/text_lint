...
class TestUniqueEncoder:
  ...
  def test_initialize__inheritance(
      self,
      unique_encoder_instance: UniqueEncoder,
  ) -> None:
    assert isinstance(
        unique_encoder_instance,
        UniqueEncoder,
    )
    assert isinstance(
        unique_encoder_instance,
  ...
  def test_encode__non_list_values__returns_json_encoded_values(
    ...
    return_value = unique_encoder_instance.encode(mocked_object)
  ...
  def test_encode__single_iterable_results__returns_unique_lists(
      self,
      unique_encoder_instance: UniqueEncoder,
      mocked_list: List[List[Any]],
  ) -> None:
    return_value = unique_encoder_instance.encode(mocked_list)
  ...
  def test_encode__multiple_iterable_results__returns_unique_lists(
      self,
      unique_encoder_instance: UniqueEncoder,
      mocked_list: List[List[Any]],
  ) -> None:
