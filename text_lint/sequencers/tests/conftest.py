...
import pytest
from text_lint.sequencers import assertions, lookups, textfile, validators
...
@pytest.fixture
def assertions_sequencer_class() -> Type[assertions.AssertionSequencer]:
  return assertions.AssertionSequencer
