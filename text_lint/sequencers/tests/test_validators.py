...
class TestValidatorSequencer:
  ...
  def test_initialize__attributes(
      self,
      validator_sequencer_class: Type[ValidatorSequencer],
  ...
  def test_initialize__loads_validators_from_schema(
      self,
      validator_sequencer_class: Type[ValidatorSequencer],
      mocked_schema: mock.Mock,
  ) -> None:
    ...
    mocked_schema.load_validators.assert_called_once_with()
